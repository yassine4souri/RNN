import numpy as np
np.random.seed(42)
fro.keras.models import Sequential#, load_model
...
texte = open(r'C:\Users\dell\Desktop\M2I\Projet RNN M2I\nietzshe.txt',encoding="utf-8").read()
...
texte_code = [vocab_to_int[l] for l in texte]
texte_decode = [int_to_vocab[i] for i in texte_code]
...
history = model.fit(X, y, validation_split=0.05, batch_size=128, epochs=13, shuffle=True).history
